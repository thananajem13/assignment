...
export const getUsersAndPostsAndComments = async (req, res) => {
    ...
    //     {
    //         $match: {
    //             isDeleted: false, isBlocked: false, confirmEmail: true
    //         }
    //     },
    //     {
    //         $lookup: {
    ...
    //         $graphLookup: {
    //             from: "Comments",
    //             startWith: "$posts.comments",
    //             connectFromField: "commentReplyTo",
    //             connectToField: "_id",
    //             as: "comments"
    //          }
    //     }
    ...
    // const users = await userModel.find({ isDeleted: false, isBlocked: false, confirmEmail: true }).populate([{
    //     path: 'postsID',
    //     select: 'name postsID',
    ...
    users.length ? res.status(200).json({ message: "Done", users }) : res.status(404).json({ message: "no user found", users })
}
